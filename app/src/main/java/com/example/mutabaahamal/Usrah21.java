...
public class Usrah21 extends AppCompatActivity {
    WebView webView;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_usrah21);
        ...
        webView.loadUrl("https://docs.google.com/forms/d/e/1FAIpQLSf1FIO4yFy8KIUIJMj6RyPYX7WesnJ3kfBf6QzSCf-Y3ZFlDQ/viewform?embedded=true");
