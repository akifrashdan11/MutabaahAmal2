...
public class Usrah19 extends AppCompatActivity {
    WebView webView;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_usrah19);
        ...
        webView.loadUrl("https://docs.google.com/forms/d/e/1FAIpQLSeJJstIOo28A5TwVSOcdj8VO_otykqZcPCM2N4eCzGCZKgbwA/viewform?embedded=true");
